    ...
    return (
        <div className="flex items-center justify-between bg-muted px-8 py-4">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-mutef-foreground">Ни одно из прав не защищено</p>
                <p>ОРГН: 148867565242</p>
            </div>

            <a href="https://github.com/chi2l3s">
                <Button variant={"link"} size={"icon-lg"} className="cursor-pointer [&_svg]:size-12">
